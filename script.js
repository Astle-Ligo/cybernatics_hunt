...
txt = "ENTER YOUR TEAM NAME"    //ASSIGNING THE INITIAL TEXT TO txt
...
document.getElementById("usertext").addEventListener("keypress", function (event) {
    if (event.keyCode == 13) {
        ...
        responses.push(document.getElementById('formTime').value = formTime() + " " + document.getElementById("usertext").value)
...
function sent() {
    ...
    else if ((userinput === answer[0]) && (startcount < 1)) {
